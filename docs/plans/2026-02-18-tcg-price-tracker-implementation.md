...
**Files:**
- Create: `tcgtracker/requirements.txt`
- Create: `tcgtracker/.env.example`
- Create: `tcgtracker/app/__init__.py`
- Create: `tcgtracker/app/config.py`

**Step 1: Create directory structure**

```bash
mkdir -p tcgtracker/app/{routers,services,templates,static/{css,js,img}}
mkdir -p tcgtracker/scripts
mkdir -p tcgtracker/tests
touch tcgtracker/app/__init__.py
touch tcgtracker/app/routers/__init__.py
touch tcgtracker/app/services/__init__.py
touch tcgtracker/tests/__init__.py
```
...
DATABASE_URL=postgresql://tcgtracker:tcgtracker@localhost:5432/tcgtracker
...
class Settings(BaseSettings):
    justtcg_api_key: str
    database_url: str = "postgresql://tcgtracker:tcgtracker@localhost:5432/tcgtracker"
...
```bash
git add tcgtracker/
git commit -m "Scaffold tcgtracker project structure and dependencies"
```
...
**Files:**
- Create: `tcgtracker/app/database.py`
- Create: `tcgtracker/app/models.py`
...
```bash
git add tcgtracker/app/database.py tcgtracker/app/models.py
...
**Files:**
- Create: `tcgtracker/alembic.ini`
- Create: `tcgtracker/alembic/env.py`
...
```bash
git add tcgtracker/alembic/ tcgtracker/alembic.ini
...
**Files:**
- Create: `tcgtracker/app/services/justtcg.py`
- Create: `tcgtracker/tests/test_justtcg.py`
...
```bash
cd tcgtracker && python -m pytest tests/test_justtcg.py -v
```
...
```bash
git add tcgtracker/app/services/justtcg.py tcgtracker/tests/test_justtcg.py
...
**Files:**
- Create: `tcgtracker/app/services/ingestion.py`
- Create: `tcgtracker/tests/test_ingestion.py`
...
```bash
git add tcgtracker/app/services/ingestion.py tcgtracker/tests/test_ingestion.py
...
**Files:**
- Create: `tcgtracker/scripts/seed.py`
...
```bash
cd tcgtracker && python scripts/seed.py
```

**Step 3: Commit**

```bash
git add tcgtracker/scripts/seed.py
...
**Files:**
- Create: `tcgtracker/scripts/ingest.py`
...
```bash
cd tcgtracker && python scripts/ingest.py
```

**Step 3: Commit**

```bash
git add tcgtracker/scripts/ingest.py
...
**Files:**
- Create: `tcgtracker/app/main.py`
- Create: `tcgtracker/app/templates/base.html`
- Create: `tcgtracker/static/css/app.css`
...
```bash
cd tcgtracker && uvicorn app.main:app --reload
```

**Step 5: Commit**

```bash
git add tcgtracker/app/main.py tcgtracker/app/templates/base.html tcgtracker/static/
...
**Files:**
- Create: `tcgtracker/app/routers/dashboard.py`
- Create: `tcgtracker/app/templates/dashboard.html`
...
```bash
git add tcgtracker/app/routers/dashboard.py tcgtracker/app/templates/dashboard.html
...
**Files:**
- Create: `tcgtracker/app/routers/search.py`
- Create: `tcgtracker/app/templates/search.html`
...
```bash
git add tcgtracker/app/routers/search.py tcgtracker/app/templates/search.html
...
**Files:**
- Create: `tcgtracker/app/routers/cards.py`
- Create: `tcgtracker/app/templates/card_detail.html`
...
```bash
git add tcgtracker/app/routers/cards.py tcgtracker/app/templates/card_detail.html tcgtracker/static/js/charts.js
...
**Files:**
- Create: `tcgtracker/app/routers/sealed.py`
- Create: `tcgtracker/app/templates/sealed.html`
...
```bash
git add tcgtracker/app/routers/sealed.py tcgtracker/app/templates/sealed.html
...
**Files:**
- Create: `tcgtracker/app/services/repricing.py`
- Create: `tcgtracker/tests/test_repricing.py`
...
```bash
git add tcgtracker/app/services/repricing.py tcgtracker/tests/test_repricing.py
...
**Files:**
- Create: `tcgtracker/app/routers/reprice.py`
- Create: `tcgtracker/app/templates/reprice.html`
...
```bash
git add tcgtracker/app/routers/reprice.py tcgtracker/app/templates/reprice.html
...
**Files:**
- Create: `tcgtracker/app/routers/watchlist.py`
- Create: `tcgtracker/app/templates/watchlist.html`
...
```bash
git add tcgtracker/app/routers/watchlist.py tcgtracker/app/templates/watchlist.html
...
**Files:**
- Create: `tcgtracker/app/services/alerts.py`
- Create: `tcgtracker/tests/test_alerts.py`
- Create: `tcgtracker/app/routers/alerts.py`
- Create: `tcgtracker/app/templates/alerts.html`
...
```bash
git add tcgtracker/app/services/alerts.py tcgtracker/tests/test_alerts.py \
       tcgtracker/app/routers/alerts.py tcgtracker/app/templates/alerts.html
...
**Files:**
- Create: `tcgtracker/app/routers/settings.py`
- Create: `tcgtracker/app/templates/settings.html`
...
```bash
git add tcgtracker/app/routers/settings.py tcgtracker/app/templates/settings.html
...
```bash
sudo -u postgres createuser tcgtracker
sudo -u postgres createdb tcgtracker -O tcgtracker
sudo -u postgres psql -c "ALTER USER tcgtracker PASSWORD 'secure-password-here';"
```
...
```bash
cd /opt
git clone <repo-url> tcgtracker
cd tcgtracker/tcgtracker
...
**Files:**
- Create: `tcgtracker/deploy/tcgtracker.service` (systemd unit)
- Create: `tcgtracker/deploy/nginx.conf` (Nginx site config)
...
[Service]
User=www-data
WorkingDirectory=/opt/tcgtracker/tcgtracker
ExecStart=/opt/tcgtracker/tcgtracker/venv/bin/uvicorn app.main:app --host 127.0.0.1 --port 8000
Restart=always
EnvironmentFile=/opt/tcgtracker/tcgtracker/.env
...
```bash
cp deploy/tcgtracker.service /etc/systemd/system/
systemctl enable tcgtracker && systemctl start tcgtracker
cp deploy/nginx.conf /etc/nginx/sites-available/tcgtracker
ln -s /etc/nginx/sites-available/tcgtracker /etc/nginx/sites-enabled/
...
```bash
crontab -e
# Add: 30 20 * * * /opt/tcgtracker/tcgtracker/venv/bin/python /opt/tcgtracker/tcgtracker/scripts/ingest.py >> /var/log/tcgtracker-ingest.log 2>&1
```

**Step 5: Commit deploy configs**

```bash
git add tcgtracker/deploy/
